## alpaca-trader watchlists remove-asset

Remove an asset from a watchlist

```
alpaca-trader watchlists remove-asset <watchlist_id> [flags]
```

### Options

```
  -h, --help            help for remove-asset
      --symbol string   Symbol to remove from the watchlist
```
